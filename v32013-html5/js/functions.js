jQuery(function () {
    ...
    /* Left/Right Navigation top/bottom template design on the blog.html. */
    jQuery('<div class="bar-top"></div>').prependTo('#blog .blogNav');
    jQuery('<div class="bar-base"></div>').appendTo('#blog .blogNav');

    /* Adds a <span> around the first word for each module headers to be then stylize. */
    jQuery('.menu-headers').html(function (i, html) {
